...
void yinling(u8 num)
{
	switch(num)
	{
		...
		case 2:PrintCom(YIN_LIANG2,9);osdelay_ms(10);speek("低音测试");break;
		...
		case 5:PrintCom(YIN_LIANG5,9);osdelay_ms(10);speek("中音测试");break;
		...
		case 9:PrintCom(YIN_LIANG9,9);osdelay_ms(10);speek("高音测试");break;
	}                                                                        
}                                 
//语速选择
void yusu(u8 num)
