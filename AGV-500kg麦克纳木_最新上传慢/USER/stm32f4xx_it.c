...
void USART3_IRQHandler(void)             
{
	...
	if(USART_GetITStatus(USART3, USART_IT_IDLE) != RESET) 
	{
		...
		{
			voltage = (HexToChar(rece3_buf[101])<<12)|(HexToChar(rece3_buf[102])<<8)|(HexToChar(rece3_buf[103])<<4)|(HexToChar(rece3_buf[104]));
			MAh 	= (HexToChar(rece3_buf[105])<<12)|(HexToChar(rece3_buf[106])<<8)|(HexToChar(rece3_buf[107])<<4)|(HexToChar(rece3_buf[108]));
			Current = (HexToChar(rece3_buf[97])<<12)|(HexToChar(rece3_buf[98])<<8)|(HexToChar(rece3_buf[99])<<4)|(HexToChar(rece3_buf[100]));
			DianChiDianLiang = MAh;
			DianChiDianLiu 	= Current;
		}		
